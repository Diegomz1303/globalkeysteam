...
export default function Home() {
  ...
  const featuredGames = games.filter(g => (g.stock || 0) > 0).slice(0, 4);
      ...
      <div className="relative pt-4 pb-12 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          {featuredGames.length > 0 ? (
            ...
            <div className="w-full max-w-6xl mx-auto h-[350px] md:h-[450px] rounded-[2rem] bg-[#121212] animate-pulse border border-gray-800 flex items-center justify-center">
            </div>
          ) : null}
        </div>
      </div>
              ...
              {isLoading ? (
                [...Array(5)].map((_, i) => (
                  <motion.div 
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="flex flex-col md:flex-row bg-[#121212] border border-gray-800 rounded-2xl overflow-hidden mb-4 shadow-xl animate-pulse"
                  >
                    <div className="w-full md:w-64 h-56 md:h-full bg-gray-900 min-h-[200px]"></div>
                    <div className="flex-1 p-6 border-b md:border-b-0 md:border-r border-gray-800 flex flex-col justify-center">
                      <div className="h-8 bg-gray-900 rounded w-3/4 mb-4"></div>
                      <div className="flex gap-2">
                        <div className="h-6 bg-gray-900 rounded-full w-20"></div>
                        <div className="h-6 bg-gray-900 rounded-full w-32"></div>
                      </div>
                    </div>
                    <div className="w-full md:w-56 p-6 flex flex-col justify-center items-end bg-[#0a0a0a]">
                      <div className="h-10 bg-gray-900 rounded w-1/2 mb-4"></div>
                      <div className="h-12 bg-gray-900 rounded-xl w-full"></div>
                    </div>
                  </motion.div>
                ))
